...
<body>
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<?php 
						...
						if (isset($_SESSION['data-not-inserted'])) {
							echo $_SESSION['data-not-inserted'];
							unset($_SESSION['data-not-inserted']);
						}
					?>
				</div>
			</div>
	...
	<!-- map -->
	<div class="map">
		<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d60618.70012353956!2d74.12683207360915!3d18.271000313919696!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2fc5a3346578b%3A0xf8f3106346ee157d!2sJejuri%2C%20Maharashtra%20412303!5e0!3m2!1sen!2sin!4v1617808276920!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
	</div>
	<!-- map end -->
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<input type="text" class="form-control" id="name" name="name" value="<?php if(isset($_SESSION['customer_username'])) echo $rows['cust_name'] ?>" placeholder="Your Name" required data-error="Please enter your name">
									<div class="help-block with-errors"></div>
								</div>                                 
							</div>
							<div class="col-md-12">
								<div class="form-group">
									<input type="text" placeholder="Your Email" id="email" class="form-control" name="email" value="<?php if(isset($_SESSION['customer_username'])) echo $rows['cust_email'] ?>" required data-error="Please enter your email">
									<div class="help-block with-errors"></div>
								</div> 
							</div>
							<div class="col-md-12">
								<div class="form-group"> 
									<textarea class="form-control" id="message" name="message" placeholder="Your Message in 500 Characters" rows="4" data-error="Write your message" required></textarea>
									<div class="help-block with-errors"></div>
								</div>
								<div class="submit-button text-center">
									<?php 
										if(isset($_SESSION['customer_username'])){
											...
											?>
												<a href="login.php" class="btn btn-common">Send Message</a>
											<?php
										}
									?>

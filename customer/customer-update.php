...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../admin/admin-css/img-upload.css">
  ...
  <body>
    ...
    <div class="container mt-4">
        ...
        <hr>
        <form action="customer-update-process.php" method="post" enctype="multipart/form-data">
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="inputEmail4">Full Name</label>
                    <input type="text" class="form-control" name="full_name" id="inputEmail4" placeholder="Full Name" value="<?php echo $cust_name ?>" required>
                </div>
                <div class="form-group col-md-6">
                    <label for="inputPassword4">Username</label>
                    <input type="text" class="form-control" name ="user_name" id="inputPassword4" placeholder="Username" value="<?php echo $cust_username ?>" required>
                </div>
                <div class="form-group col-md-6">
                <label for="inputPassword4">Email</label>
                <input type="email" class="form-control" name ="email" id="inputPassword" placeholder="Email" value="<?php echo $cust_email ?>" required>
                </div>
                <div class="form-group col-md-6">
            ...
            <div class="profile-pic-div">
                <img src="../admin/admin-img/image.jpg" id="photo">
                <?php 
            ...
            <div class="form-group" style="width: 50%;">
                ...
                <input type="phone" class="form-control" name ="phone_no" id="inputPassword4" placeholder="Phone Number" value="<?php echo $cust_phone ?>" required>
                <br>

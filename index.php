			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-12 text-center">
					<div class="inner-column">
						...
						<a class="btn btn-lg btn-circle btn-outline-new-white" href="about.php">Read More</a>
					</div>
				</div>
			</div>
		</div>
                    ...
                    <div class="col-lg-12">
                        <div class="special-menu text-center">
                            <div class="button-group filter-button-group">
								...
								<a href="menu.php"><button>More</button></a>
                            </div>
                        </div>
                    </div>
                </div> -->
			...
			<div class="row special-list">
				<?php 
					...
					$query = "SELECT * FROM tbl_menu 
							...
							AND menu_active = 'Active' ORDER BY menu_name LIMIT 10;
						";
							...
							<div class="col-lg-4 col-md-6 special-grid active">
								<div class="gallery-single fix">
									...
									<div class="why-text">
										...
										<a style="padding: 10px;" href="product.php?menu_id=<?php echo $menu_id; ?>"><i title="Details" style="font-size: 25px;" class="fa fa-arrow-right" aria-hidden="true"></i></a>
										<?php 

...
<body>
	...
	<?php 
		...
		if (isset($_GET['blog_id'])) {
			...
			$query = "SELECT * FROM tbl_blog WHERE blog_id = " . $_GET['blog_id'] . ";";
		} else {
			
			$query = "SELECT * FROM tbl_blog ORDER BY blog_id DESC LIMIT 1";
		}
					...
					<div class="right-side-blog">
						...
						<div class="post-box-blog">
							...
							<?php 
								...
								//query to display blogs
								$query = "SELECT * FROM tbl_blog ORDER BY blog_id DESC LIMIT 5";

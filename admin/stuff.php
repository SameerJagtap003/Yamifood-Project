	...
	<table class="content-table">
		<thead>
			<tr>
				...
				<h4>Want To add Stuff</h4>
					<?php 
					
						if (isset($_SESSION['delete-stuff-msg'])) {
							echo $_SESSION['delete-stuff-msg'];
							unset($_SESSION['delete-stuff-msg']);
						}
					...
					?>
            		<a href="stuff-add.php"><button type="submit" class="submit" name="submit">Add</button></a>
            	</div>
				</td>
			</tr>
			<tr>
		...
		<tbody>
			...
			<?php 
				...
				while ($rows = pg_fetch_assoc($result)) {
					...
					$stuff_id = $rows['stuff_id'];
					?>
						<tr class="active-row">
							<td><?php echo $sr++ ?></td>
							<td><?php echo $rows['stuff_name'] ?></td>
							<td><?php echo $rows['stuff_address'] ?></td>
							<td><?php echo $rows['stuff_possition'] ?></td>
							<td><a href="stuff-delete.php?stuff_id=<?php echo $stuff_id; ?>">Delete</a></td>
						</tr>
					<?php
				}

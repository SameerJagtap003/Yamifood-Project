        ...
        <form action="admin-add-process.php" method="post" enctype="multipart/form-data">
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name ="user_name" id="inputPassword4" placeholder="Username" required>
                </div>
                <div class="form-group col-md-6">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="exampleFormControlTextarea1" rows="4" name="address" placeholder="Address" required></textarea>
            </div>
            <?php 

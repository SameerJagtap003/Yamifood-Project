					...
					<div class="blog-inner-details-page">
                        <div class="blog-comment-box">
                            ...
                            <?php 
                                ...
                                $query = "SELECT * FROM tbl_contact ORDER BY cont_id DESC LIMIT 5";
                                        ...
                                        ?>
                                            ...
                                            <div class="comment-item">
                                                ...
                                                <div class="comment-item-right">
                                                    ...
                                                    <a href="replay.php?cont_id=<?php echo $cont_id ?>" class="right-btn-re"><i class="fa fa-reply" aria-hidden="true"></i> Reply</a>
                                                </div>
                                            </div><br>
                                            <hr>
                                        <?php
                            ...
                            <a href="messages_details.php" class="right-btn-re">All Messages</a>

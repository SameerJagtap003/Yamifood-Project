    ...
    <table class="content-table">
            ...
            <tr>
				<td class="active-row" colspan="10">
                    <div class="subscribe_form" style="width: 50%;">
                        <h4>Show All Bookings</h4>
                        <a href="all_tbl_booking.php"><button type="submit" class="submit" name="submit">Show</button></a>
                    </div>
				</td>
			</tr>
		...
		<tbody>
			...
			<?php 
				...
				//Query for data
				$query = "SELECT * FROM tbl_table WHERE booking_date = CURRENT_DATE ORDER BY booking_date DESC";

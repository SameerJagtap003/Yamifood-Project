		...
		<div class="container text-center">
			<div class="row">
				<div class="col-lg-12">
					<h1>Reservation</h1>
					<?php 
						if (isset($_SESSION['table_booking'])) {
							echo $_SESSION['table_booking'];
							unset($_SESSION['table_booking']);
						}
					?>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-12 col-sm-12 col-xs-12">
					<div class="contact-block">
						<form action="customer/table_reservation_process.php" method="post">
							<div class="row">
								<div class="col-md-6">
									<h3>Book a table</h3>
									<div class="col-md-12">
										<div class="form-group">
											<input class="datepicker picker__input form-control" name="tbl_date" type="date" placeholder="Enter Date" value="" required data-error="Please enter Date">
											<!-- <div class="help-block with-errors"></div> -->
										</div>                                 
									</div>
									<div class="col-md-12">
										<div class="form-group">
											<input class="time form-control picker__input" type="time" name="tbl_time" placeholder="Enter Time" required data-error="Please enter time">
											<!-- <div class="help-block with-errors"></div> -->
										</div>                                 
									</div>
									<div class="col-md-12">
										<div class="form-group">
											<select class="custom-select d-block form-control" name="tbl_person" required data-error="Please select Person">
								...
								<div class="col-md-6">
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											value="<?php if(isset($_SESSION['customer_username'])) echo $rows['cust_name'] ?>" required data-error="Please enter your name">
											<div class="help-block with-errors"></div>
										</div>                                 
									</div>
									<div class="col-md-12">
										<div class="form-group">
											<input type="text" placeholder="Your Email" name="cust_email" class="form-control" name="email" 
											value="<?php if(isset($_SESSION['customer_username'])) echo $rows['cust_email'] ?>" required data-error="Please enter your email">
											<div class="help-block with-errors"></div>
										</div> 
									</div>
									<div class="col-md-12">
										<div class="form-group">
											<input type="text" placeholder="Phone No" name="cust_phone" class="form-control" name="phone" required data-error="Please enter your Numbar">
											<div class="help-block with-errors"></div>
										</div> 
									</div>
								</div>
								<div class="col-md-12">
									...
									<?php 
										if(isset($_SESSION['customer_username'])){
											?>
												<input type="submit" class="btn btn-common" value="Book Table">
											<?php
										} else {
											?>
												<a href="login.php" class="btn btn-common">Book Table</a>
											<?php
										}
									?>
